...
${OUT_DIR}/thief.a: ${OUT_DIR}/thief_process.o ${OUT_DIR}/waiting_process.o ${OUT_DIR}/waiting_queue.o
	${AR} ${AR_FLAGS} ${OUT_DIR}/thief.a ${OUT_DIR}/thief_process.o ${OUT_DIR}/waiting_process.o ${OUT_DIR}/waiting_queue.o
