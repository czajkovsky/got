...
all: ${OUT_DIR} ${OUT_DIR}/main.o ${OUT_DIR}/thief_process.o ${OUT_DIR}/waiting_process.o ${OUT_DIR}/waiting_queue.o
	${LD} -o ${OUT_DIR}/main ${OUT_DIR}/main.o ${OUT_DIR}/thief_process.o ${OUT_DIR}/waiting_process.o ${OUT_DIR}/waiting_queue.o ${LD_FLAGS}
