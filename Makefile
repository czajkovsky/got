...
MAIN_SRCS = main.cpp
THIEF_LIB_SRCS = communicator.cpp left_house.cpp logger.cpp message.cpp thief_process.cpp time_point.cpp waiting_process.cpp waiting_process_priority_queue.cpp
